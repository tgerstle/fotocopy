...
import fs from "fs";
import { runDiscovery } from "./discovery/spider";
import { crawlAndCapture } from "./crawler/capture";
import { computeGlobalIntersections } from "./intersection/hash_engine";
import { purgeAndSlicePage } from "./intersection/orchestrator";
...
import { consolidateComponents, extractSampleData } from "./llm/consolidator";
...
import { extractSandboxTemplate } from "./scaffolding/sandbox_extractor";
import { injectTokensToCSS } from "./scaffolding/token_injector";
import { extractTokens } from "./crawler/token_extractor";
