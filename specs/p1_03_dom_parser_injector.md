...
4.  **Capture Design Tokens (`W3C DTCG Format`) & Interactive State Cleansing:**
    ...
    - **Crucial Requirement:** Format output strictly to the **W3C Design Tokens Community Group** object structure (`{ "color": { "primary": { "$value": "#fff", "$type": "color" } } }`). This prevents translation steps and ensures React/Tailwind configs can consume CSS variables natively in Phase 4.
