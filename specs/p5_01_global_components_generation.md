# Phase 5.1: Global Component Scaffolding 
...
{
  "globalHashes": [
    "80ac05650e848e1cd0405...",
    "4bd081edb471b0eaf549d..."
  ]
}
```

### 2. Single-Instance Lookup
Rather than scanning directories of chunks, the orchestrator iterates over the `globalHashes` array, locates the *first occurrence* of that hash mapped to any physical DOM output in the `live_capture` directory, and extracts exactly ONE chunked representation. 
